...
int main(int argc, char *argv[])
{
    ...
    // Iterate over the boundary patches to get face centers and the cell they are part of
    ...
    // Iterate over all cells and list their faces and points, excluding "Side" faces
...
// Get the owner and neighbour lists
const labelList& owner = mesh.owner();
const labelList& neighbour = mesh.neighbour();
