...
def loadModel(conf,nAttributesDict,device):
    ...
    if conf["modelParam"]["model"] == "final_design":
        ...
        from ModelsSpeed.perlin.MeshGraphNetCNN import GraphUNetMediumLessLayers,GraphUNetSmallLessLayers,GraphUNetVerySmallLessLayers,GraphUNetVeryVerySmallLessLayers
    ...
    if conf["modelParam"]["model"] == "final_design_cfd":
        # from Models.GraphUnetSimple.GraphUnet import *
        from ModelsSpeed.fieldFast.MeshGraphNetCNN import GraphUNetMediumLessLayers, GraphUNetFullScaleLessLayers, GraphUNetVeryVeryVerySmallLessLayers,GraphUNetSmallLessLayers,GraphUNetVerySmallLessLayers,GraphUNetVeryVerySmallLessLayers
    ...
    elif conf["modelParam"]["model"] == "magBase":
        # from Models.GraphUnetSimple.GraphUnet import *
        from ModelsSpeed.magnitude.MeshGraphNetCNN import Small, VerySmall, VeryVerySmall, VeryVeryVerySmall
