...
if __name__ == '__main__':
    ...
    test_case_path = "/home/justinbrusche/datasets/Step1_Komega/case_0"
    ...
    output1 = np.where(output1==0,0.0000000001,output1)
    # output1 = np.where(output1==0,0,1)
    # output1 = np.where(output1==0,0,1)
    print(closest_cell_index)
    # output1[closest_cell_index] = 100
    ...
    # plt.scatter([x_coords[closest_cell_index]],[y_coords[closest_cell_index]],'x', color="r", label="start cell")
    plt.plot([x_coords[closest_cell_index]],[y_coords[closest_cell_index]],'x', color="r", label="Start cell")
    plt.tight_layout()
    plt.legend()
    plt.savefig(f"aggrDistance.png")
    plt.show()
