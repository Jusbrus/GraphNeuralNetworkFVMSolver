...
sys.path.append("/home/justinbrusche/scripts_final/trainTestModel/ModelsSpeed/fieldFast")
...
#         print("GraphUNet_BC1Gradient0_FullScale_LessLayers_no_last_norm_cfd")
#         super().__init__()
#
#         self.inInputCellCenters = nn.InstanceNorm1d(2)
#         self.inInputFace = nn.InstanceNorm1d(3)
#
#         self.convN_1 = _ConvBlock1(2, 3,29,32, GNNData)
