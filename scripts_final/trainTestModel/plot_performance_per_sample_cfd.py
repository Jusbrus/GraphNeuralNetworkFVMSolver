...
config_file = 'config_files_step1/small.yaml'
config_file = 'config_files_cyl_incomplete/field_40.yaml'
...
testDataLoader = loadDataLoader(test_case_path, np.arange(90, 100,5),
                                1,dataDictMeshes,
                                normalize_data=True,
        ...
        for p, pEqnD, pEqnFace, pEqnSource, inputCellArray, faceArray_incl_boundaries, BCArray, *factors  in testDataLoader:
            ...
            if 1==1:
                ...
                if plot_type == '2d':
                    ...
                    ax = fig.add_subplot(2,2, 4)
                    plot_mesh_triangles(fig, ax, cellPoints, x_mesh, y_mesh, inputCellArray[0,:,0],"Source",centered_colorbar=True,apply_percentile=True)
                    plt.tight_layout()
