...
# Models to train
config_file_list = ['config_files_step3/small.yaml']

# config_file_list = ['config_files_cyl_incomplete/field_20.yaml',
#                      'config_files_cyl_incomplete/field_30.yaml',
#                      'config_files_cyl_incomplete/field_40.yaml',
#                     'config_files_cyl_incomplete/field_50.yaml']
